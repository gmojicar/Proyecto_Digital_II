...
# Servo
    ("servo", 0, Pins("H4"), IOStandard("LVCMOS33")),
#---------------    
    
    
# Ultrasonido
    ("trig", 0, Pins("H1"), IOStandard("LVCMOS33")),
...
# Infrarojo
    ...
    ("infras", 3, Pins("J5"), IOStandard("LVCMOS33")),
    ("infras", 4, Pins("J6"), IOStandard("LVCMOS33")),
#---------------

# Motores
    ("right", 0, Pins("G6"), IOStandard("LVCMOS33")),
    ("right", 1, Pins("E7"), IOStandard("LVCMOS33")),
    ("left", 0, Pins("J3"), IOStandard("LVCMOS33")),
    ("left", 1, Pins("J4"), IOStandard("LVCMOS33")),
