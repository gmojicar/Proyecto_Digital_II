...
reg  csrbank4_move0_re = 1'd0;
wire [2:0] csrbank4_move0_r;
reg  csrbank4_move0_we = 1'd0;
wire [2:0] csrbank4_move0_w;
wire csrbank4_sel;
wire [13:0] interface5_bank_bus_adr;
wire interface5_bank_bus_we;
wire [31:0] interface5_bank_bus_dat_w;
reg  [31:0] interface5_bank_bus_dat_r = 32'd0;
reg  csrbank5_ctr0_re = 1'd0;
wire [1:0] csrbank5_ctr0_r;
reg  csrbank5_ctr0_we = 1'd0;
wire [1:0] csrbank5_ctr0_w;
wire csrbank5_sel;
wire [13:0] interface6_bank_bus_adr;
wire interface6_bank_bus_we;
wire [31:0] interface6_bank_bus_dat_w;
reg  [31:0] interface6_bank_bus_dat_r = 32'd0;
reg  csrbank6_load0_re = 1'd0;
wire [31:0] csrbank6_load0_r;
reg  csrbank6_load0_we = 1'd0;
wire [31:0] csrbank6_load0_w;
reg  csrbank6_reload0_re = 1'd0;
wire [31:0] csrbank6_reload0_r;
reg  csrbank6_reload0_we = 1'd0;
wire [31:0] csrbank6_reload0_w;
reg  csrbank6_en0_re = 1'd0;
wire csrbank6_en0_r;
reg  csrbank6_en0_we = 1'd0;
wire csrbank6_en0_w;
reg  csrbank6_update_value0_re = 1'd0;
wire csrbank6_update_value0_r;
reg  csrbank6_update_value0_we = 1'd0;
wire csrbank6_update_value0_w;
reg  csrbank6_value_re = 1'd0;
wire [31:0] csrbank6_value_r;
reg  csrbank6_value_we = 1'd0;
...
reg  csrbank7_txfull_re = 1'd0;
wire csrbank7_txfull_r;
reg  csrbank7_txfull_we = 1'd0;
wire csrbank7_txfull_w;
reg  csrbank7_rxempty_re = 1'd0;
wire csrbank7_rxempty_r;
reg  csrbank7_rxempty_we = 1'd0;
wire csrbank7_rxempty_w;
reg  csrbank7_ev_status_re = 1'd0;
wire [1:0] csrbank7_ev_status_r;
reg  csrbank7_ev_status_we = 1'd0;
wire [1:0] csrbank7_ev_status_w;
reg  csrbank7_ev_pending_re = 1'd0;
wire [1:0] csrbank7_ev_pending_r;
reg  csrbank7_ev_pending_we = 1'd0;
wire [1:0] csrbank7_ev_pending_w;
...
reg  csrbank7_txempty_re = 1'd0;
wire csrbank7_txempty_r;
reg  csrbank7_txempty_we = 1'd0;
wire csrbank7_txempty_w;
reg  csrbank7_rxfull_re = 1'd0;
wire csrbank7_rxfull_r;
reg  csrbank7_rxfull_we = 1'd0;
wire csrbank7_rxfull_w;
wire csrbank7_sel;
...
reg  csrbank8_init0_re = 1'd0;
wire csrbank8_init0_r;
reg  csrbank8_init0_we = 1'd0;
wire csrbank8_init0_w;
reg  csrbank8_dist_re = 1'd0;
wire [8:0] csrbank8_dist_r;
reg  csrbank8_dist_we = 1'd0;
wire [8:0] csrbank8_dist_w;
reg  csrbank8_done_re = 1'd0;
wire csrbank8_done_r;
reg  csrbank8_done_we = 1'd0;
wire csrbank8_done_w;
wire csrbank8_sel;
...
assign csrbank0_sel = (interface0_bank_bus_adr[13:9] == 3'd5);
...
assign csrbank3_infras2_w = infrarrojo_status[4:0];
assign infrarrojo_we = csrbank3_infras2_we;
assign csrbank4_sel = (interface4_bank_bus_adr[13:9] == 2'd3);
assign csrbank4_move0_r = interface4_bank_bus_dat_w[2:0];
always @(*) begin
	csrbank4_move0_re <= 1'd0;
	csrbank4_move0_we <= 1'd0;
	if ((csrbank4_sel & (interface4_bank_bus_adr[8:0] == 1'd0))) begin
		csrbank4_move0_re <= interface4_bank_bus_we;
		csrbank4_move0_we <= (~interface4_bank_bus_we);
	end
end
assign csrbank4_move0_w = ruedas_storage[2:0];
assign csrbank5_sel = (interface5_bank_bus_adr[13:9] == 1'd0);
assign csrbank5_ctr0_r = interface5_bank_bus_dat_w[1:0];
always @(*) begin
	csrbank5_ctr0_re <= 1'd0;
	csrbank5_ctr0_we <= 1'd0;
	if ((csrbank5_sel & (interface5_bank_bus_adr[8:0] == 1'd0))) begin
		csrbank5_ctr0_re <= interface5_bank_bus_we;
		csrbank5_ctr0_we <= (~interface5_bank_bus_we);
	end
end
assign csrbank5_ctr0_w = servo_radar_storage[1:0];
assign csrbank6_sel = (interface6_bank_bus_adr[13:9] == 3'd7);
assign csrbank6_load0_r = interface6_bank_bus_dat_w[31:0];
always @(*) begin
	csrbank6_load0_we <= 1'd0;
	csrbank6_load0_re <= 1'd0;
	if ((csrbank6_sel & (interface6_bank_bus_adr[8:0] == 1'd0))) begin
		csrbank6_load0_re <= interface6_bank_bus_we;
		csrbank6_load0_we <= (~interface6_bank_bus_we);
	end
end
assign csrbank6_reload0_r = interface6_bank_bus_dat_w[31:0];
always @(*) begin
	csrbank6_reload0_we <= 1'd0;
	csrbank6_reload0_re <= 1'd0;
	if ((csrbank6_sel & (interface6_bank_bus_adr[8:0] == 1'd1))) begin
		csrbank6_reload0_re <= interface6_bank_bus_we;
		csrbank6_reload0_we <= (~interface6_bank_bus_we);
	end
end
assign csrbank6_en0_r = interface6_bank_bus_dat_w[0];
always @(*) begin
	csrbank6_en0_re <= 1'd0;
	csrbank6_en0_we <= 1'd0;
	if ((csrbank6_sel & (interface6_bank_bus_adr[8:0] == 2'd2))) begin
		csrbank6_en0_re <= interface6_bank_bus_we;
		csrbank6_en0_we <= (~interface6_bank_bus_we);
	end
end
assign csrbank6_update_value0_r = interface6_bank_bus_dat_w[0];
always @(*) begin
	csrbank6_update_value0_we <= 1'd0;
	csrbank6_update_value0_re <= 1'd0;
	if ((csrbank6_sel & (interface6_bank_bus_adr[8:0] == 2'd3))) begin
		csrbank6_update_value0_re <= interface6_bank_bus_we;
		csrbank6_update_value0_we <= (~interface6_bank_bus_we);
	end
end
assign csrbank6_value_r = interface6_bank_bus_dat_w[31:0];
always @(*) begin
	csrbank6_value_re <= 1'd0;
	csrbank6_value_we <= 1'd0;
	if ((csrbank6_sel & (interface6_bank_bus_adr[8:0] == 3'd4))) begin
		csrbank6_value_re <= interface6_bank_bus_we;
		csrbank6_value_we <= (~interface6_bank_bus_we);
	end
end
...
assign csrbank6_load0_w = timer_load_storage[31:0];
assign csrbank6_reload0_w = timer_reload_storage[31:0];
assign csrbank6_en0_w = timer_en_storage;
assign csrbank6_update_value0_w = timer_update_value_storage;
assign csrbank6_value_w = timer_value_status[31:0];
assign timer_value_we = csrbank6_value_we;
assign timer_status_status = timer_zero0;
assign csrbank6_ev_status_w = timer_status_status;
assign timer_status_we = csrbank6_ev_status_we;
assign timer_pending_status = timer_zero1;
assign csrbank6_ev_pending_w = timer_pending_status;
assign timer_pending_we = csrbank6_ev_pending_we;
assign timer_zero2 = timer_enable_storage;
assign csrbank6_ev_enable0_w = timer_enable_storage;
...
always @(*) begin
	...
	if ((csrbank7_sel & (interface7_bank_bus_adr[8:0] == 1'd0))) begin
		uart_rxtx_re <= interface7_bank_bus_we;
		uart_rxtx_we <= (~interface7_bank_bus_we);
	end
end
assign csrbank7_txfull_r = interface7_bank_bus_dat_w[0];
always @(*) begin
	csrbank7_txfull_re <= 1'd0;
	csrbank7_txfull_we <= 1'd0;
	if ((csrbank7_sel & (interface7_bank_bus_adr[8:0] == 1'd1))) begin
		csrbank7_txfull_re <= interface7_bank_bus_we;
		csrbank7_txfull_we <= (~interface7_bank_bus_we);
	end
end
assign csrbank7_rxempty_r = interface7_bank_bus_dat_w[0];
always @(*) begin
	csrbank7_rxempty_re <= 1'd0;
	csrbank7_rxempty_we <= 1'd0;
	if ((csrbank7_sel & (interface7_bank_bus_adr[8:0] == 2'd2))) begin
		csrbank7_rxempty_re <= interface7_bank_bus_we;
		csrbank7_rxempty_we <= (~interface7_bank_bus_we);
	end
end
assign csrbank7_ev_status_r = interface7_bank_bus_dat_w[1:0];
always @(*) begin
...
assign csrbank7_ev_pending_r = interface7_bank_bus_dat_w[1:0];
always @(*) begin
...
assign csrbank7_txempty_r = interface7_bank_bus_dat_w[0];
always @(*) begin
	csrbank7_txempty_we <= 1'd0;
	csrbank7_txempty_re <= 1'd0;
	if ((csrbank7_sel & (interface7_bank_bus_adr[8:0] == 3'd6))) begin
		csrbank7_txempty_re <= interface7_bank_bus_we;
		csrbank7_txempty_we <= (~interface7_bank_bus_we);
	end
end
assign csrbank7_rxfull_r = interface7_bank_bus_dat_w[0];
always @(*) begin
	csrbank7_rxfull_we <= 1'd0;
	csrbank7_rxfull_re <= 1'd0;
	if ((csrbank7_sel & (interface7_bank_bus_adr[8:0] == 3'd7))) begin
		csrbank7_rxfull_re <= interface7_bank_bus_we;
		csrbank7_rxfull_we <= (~interface7_bank_bus_we);
	end
end
assign csrbank7_txfull_w = uart_txfull_status;
assign uart_txfull_we = csrbank7_txfull_we;
assign csrbank7_rxempty_w = uart_rxempty_status;
assign uart_rxempty_we = csrbank7_rxempty_we;
always @(*) begin
	uart_status_status <= 2'd0;
	uart_status_status[0] <= uart_tx0;
	uart_status_status[1] <= uart_rx0;
end
assign csrbank7_ev_status_w = uart_status_status[1:0];
assign uart_status_we = csrbank7_ev_status_we;
always @(*) begin
	uart_pending_status <= 2'd0;
	uart_pending_status[0] <= uart_tx1;
	uart_pending_status[1] <= uart_rx1;
end
assign csrbank7_ev_pending_w = uart_pending_status[1:0];
assign uart_pending_we = csrbank7_ev_pending_we;
assign uart_tx2 = uart_enable_storage[0];
assign uart_rx2 = uart_enable_storage[1];
assign csrbank7_ev_enable0_w = uart_enable_storage[1:0];
assign csrbank7_txempty_w = uart_txempty_status;
assign uart_txempty_we = csrbank7_txempty_we;
assign csrbank7_rxfull_w = uart_rxfull_status;
assign uart_rxfull_we = csrbank7_rxfull_we;
assign csrbank8_sel = (interface8_bank_bus_adr[13:9] == 1'd1);
assign csrbank8_init0_r = interface8_bank_bus_dat_w[0];
always @(*) begin
	csrbank8_init0_re <= 1'd0;
	csrbank8_init0_we <= 1'd0;
	if ((csrbank8_sel & (interface8_bank_bus_adr[8:0] == 1'd0))) begin
		csrbank8_init0_re <= interface8_bank_bus_we;
		csrbank8_init0_we <= (~interface8_bank_bus_we);
	end
end
assign csrbank8_dist_r = interface8_bank_bus_dat_w[8:0];
always @(*) begin
	csrbank8_dist_re <= 1'd0;
	csrbank8_dist_we <= 1'd0;
	if ((csrbank8_sel & (interface8_bank_bus_adr[8:0] == 1'd1))) begin
		csrbank8_dist_re <= interface8_bank_bus_we;
		csrbank8_dist_we <= (~interface8_bank_bus_we);
	end
end
assign csrbank8_done_r = interface8_bank_bus_dat_w[0];
always @(*) begin
	csrbank8_done_we <= 1'd0;
	csrbank8_done_re <= 1'd0;
	if ((csrbank8_sel & (interface8_bank_bus_adr[8:0] == 2'd2))) begin
		csrbank8_done_re <= interface8_bank_bus_we;
		csrbank8_done_we <= (~interface8_bank_bus_we);
	end
end
assign csrbank8_init0_w = init_storage;
assign csrbank8_dist_w = dist_status[8:0];
assign dist_we = csrbank8_dist_we;
assign csrbank8_done_w = done_status;
assign done_we = csrbank8_done_we;
...
always @(posedge sys_clk) begin
	...
	infrarrojo_re <= csrbank3_infras2_re;
	interface4_bank_bus_dat_r <= 1'd0;
	if (csrbank4_sel) begin
		case (interface4_bank_bus_adr[8:0])
			1'd0: begin
				interface4_bank_bus_dat_r <= csrbank4_move0_w;
			end
		endcase
	end
	if (csrbank4_move0_re) begin
		ruedas_storage[2:0] <= csrbank4_move0_r;
	end
	ruedas_re <= csrbank4_move0_re;
	interface5_bank_bus_dat_r <= 1'd0;
	if (csrbank5_sel) begin
		case (interface5_bank_bus_adr[8:0])
			1'd0: begin
				interface5_bank_bus_dat_r <= csrbank5_ctr0_w;
			end
		endcase
	end
	if (csrbank5_ctr0_re) begin
		servo_radar_storage[1:0] <= csrbank5_ctr0_r;
	end
	servo_radar_re <= csrbank5_ctr0_re;
	...
	if (csrbank6_sel) begin
		case (interface6_bank_bus_adr[8:0])
			...
			2'd3: begin
				interface6_bank_bus_dat_r <= csrbank6_update_value0_w;
			end
			3'd4: begin
	...
	if (csrbank6_load0_re) begin
		timer_load_storage[31:0] <= csrbank6_load0_r;
	end
	timer_load_re <= csrbank6_load0_re;
	if (csrbank6_reload0_re) begin
		timer_reload_storage[31:0] <= csrbank6_reload0_r;
	end
	timer_reload_re <= csrbank6_reload0_re;
	if (csrbank6_en0_re) begin
		timer_en_storage <= csrbank6_en0_r;
	end
	timer_en_re <= csrbank6_en0_re;
	if (csrbank6_update_value0_re) begin
		timer_update_value_storage <= csrbank6_update_value0_r;
	end
	timer_update_value_re <= csrbank6_update_value0_re;
	timer_value_re <= csrbank6_value_re;
	timer_status_re <= csrbank6_ev_status_re;
	if (csrbank6_ev_pending_re) begin
		timer_pending_r <= csrbank6_ev_pending_r;
	end
	timer_pending_re <= csrbank6_ev_pending_re;
	if (csrbank6_ev_enable0_re) begin
		timer_enable_storage <= csrbank6_ev_enable0_r;
	end
	timer_enable_re <= csrbank6_ev_enable0_re;
	...
	if (csrbank7_sel) begin
		case (interface7_bank_bus_adr[8:0])
			...
			3'd6: begin
				interface7_bank_bus_dat_r <= csrbank7_txempty_w;
			end
			3'd7: begin
				interface7_bank_bus_dat_r <= csrbank7_rxfull_w;
			end
		endcase
	end
	uart_txfull_re <= csrbank7_txfull_re;
	uart_rxempty_re <= csrbank7_rxempty_re;
	uart_status_re <= csrbank7_ev_status_re;
	if (csrbank7_ev_pending_re) begin
		uart_pending_r[1:0] <= csrbank7_ev_pending_r;
	end
	uart_pending_re <= csrbank7_ev_pending_re;
	if (csrbank7_ev_enable0_re) begin
		uart_enable_storage[1:0] <= csrbank7_ev_enable0_r;
	end
	uart_enable_re <= csrbank7_ev_enable0_re;
	uart_txempty_re <= csrbank7_txempty_re;
	uart_rxfull_re <= csrbank7_rxfull_re;
	interface8_bank_bus_dat_r <= 1'd0;
	if (csrbank8_sel) begin
		case (interface8_bank_bus_adr[8:0])
			1'd0: begin
				interface8_bank_bus_dat_r <= csrbank8_init0_w;
			end
			1'd1: begin
				interface8_bank_bus_dat_r <= csrbank8_dist_w;
			end
			2'd2: begin
				interface8_bank_bus_dat_r <= csrbank8_done_w;
			end
		endcase
	end
	if (csrbank8_init0_re) begin
		init_storage <= csrbank8_init0_r;
	end
	init_re <= csrbank8_init0_re;
	dist_re <= csrbank8_dist_re;
	done_re <= csrbank8_done_re;
	if (sys_rst) begin
		reset_storage <= 2'd0;
		reset_re <= 1'd0;
...
//------------------------------------------------------------------------------
// Memory mem: 5382-words x 32-bit
//------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------
// Memory mem_2: 3328-words x 32-bit
//------------------------------------------------------------------------------
// Port 0 | Read: Sync  | Write: Sync | Mode: Write-First | Write-Granularity: 8 
...
// -----------------------------------------------------------------------------
//  Auto-Generated by LiteX on 2022-02-08 15:43:00.
//------------------------------------------------------------------------------
