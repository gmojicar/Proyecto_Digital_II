...
_io = [
    ("Forma",  0, Pins("T8"), IOStandard("LVCMOS33")),
    ("Forma",  1, Pins("V9"), IOStandard("LVCMOS33")),
    ("led",  2, Pins("R8"), IOStandard("LVCMOS33")),
    ("led",  3, Pins("T6"), IOStandard("LVCMOS33")),
    ("PromedioColor",  0, Pins("T5"), IOStandard("LVCMOS33")),
    ("PromedioColor",  1, Pins("T4"), IOStandard("LVCMOS33")),
